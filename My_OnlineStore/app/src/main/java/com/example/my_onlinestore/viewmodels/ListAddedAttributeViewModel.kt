...
class ListAddedAttributeViewModel@ViewModelInject constructor(
        private val mRepository: IAttributeRepository,
        @Assisted private val savedStateHandle: SavedStateHandle
): ViewModel() {
    private val mAttributeList = MutableLiveData<List<AddedAttributeViewModel>>()
    private val mIsLoading = MutableLiveData<Boolean>(true)

    val attributeList: LiveData<List<AddedAttributeViewModel>>
        get() = mAttributeList
